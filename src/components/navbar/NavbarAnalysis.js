...
import AnalysisNavbarLinks from "components/navbar/NavbarLinksAnalysis";
  ...
  return (
    ...
    >
      <Flex
        ...
        mb={gap}
      >
        <Box mb={{ sm: "5px", md: "5px" }} mt={{ sm: "00px", md: "0px" }}>
          <Breadcrumb>
      ...
      {secondary ? <Text color="grey">{message}</Text> : null}
    </Box>
  );
}
